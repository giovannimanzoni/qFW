...
abstract class SidebarTpl
{
    ...
    protected function startLev1(string $target, string $fa, int $lev1, string $txt, string $url = ''): string
    {
        ...
        $html = '<li ';
        if ($url == '') {
            $html .= "data-toggle='collapse' data-target='#$target' class='collapsed ";
        } else {
            $html .= "class='";
        }
        ...
        if ($url == '') {
            $html .= '<span class="arrowdownfa"><i class="fas fa-angle-down"></i></span>';
        }
        $html .= "</a></li>";
    ...
    protected function makeLev2(int $lev2, string $url, string $txt): string
    {
        ...
        $html .= "\"><a href='$urlFull'><span class='arrowfaright'><i class='fas fa-angle-right'>
                    </i></span> $txt</a></li>";
